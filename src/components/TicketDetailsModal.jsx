...
function TicketDetailsModal({ticket}) {
    ...
    async function handleTicketUpdate() {
        ...
        if(searchParams.get("status") != 'AllTickets') {
        ...
        <dialog id="ticketDetailsModal" className="modal">
            {
                ...
                <div className="modal-box">
                    ...
                    {<p className="py-4 text-sm font-semibold">Created By : <span className="text-yellow-500">{selectedTicket.assignee}</span></p>}
                    <p className="py-4 text-sm font-semibold">Assigned To : <span className="text-yellow-500">{selectedTicket.assignedTo}</span></p>
